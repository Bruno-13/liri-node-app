...
console.log("After typing 'node liri' type > my-tweets, spotify-this-song, movie-this, or do-what-it-says < to get started!");
...
function getTweets(){
  console.log('Most current tweets');
...
function getSpotify(){
  console.log('Checking the Spotify function');
...
function getMovie(){
  console.log('Checking the Movie feature');
...
function getRandom(){
  console.log('testing random.txt');
